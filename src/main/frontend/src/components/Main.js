      ...
      <div id='home' className='main'>
        <div className='leftSide'>
          ...
          <p>and I'm a web developer.
            <span id="show" style={{ transform: `scale(${scroll}, 1)`, opacity: `${scroll * 8}` }} >I guess</span>
            <span id="show" style={{ transform: `scale(${scroll}, 1)`, opacity: `${scroll * 4}` }} >Some day</span>
            <span id="show" style={{ transform: `scale(${scroll}, 1)`, opacity: `${scroll * 2}` }} >Finally</span>
          </p>
        </div>
